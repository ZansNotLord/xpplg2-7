...
const Schedule = () => {
    ...
    piketGroup = [
        ["Abdul", "Rizqy", "Mindo", "Rasya M", "Ival", "Nazriel", "Fathir"],
        ["Rafik", "Rasya A", "Farhan", "Syipa P", "Nazwa", "Rangga", "Fauzan"],
        ["Nabila", "Rasya Z", "Rifadz", "Ilham", "Richy", "Ayu"],
        ["Siti", "Najla", "Dimas", "Sofyan", "Desfitta", "Sendi"],
        ["Sopi", "ZamZam", "Donita", "Listianti", "Shabrina", "Syifa A"],
    ]
