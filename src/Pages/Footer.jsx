					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/zans.not.lords/?hl=id" class="hover:underline">
										ZansLord
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/x_pplg2sevbe/?hl=id" class="hover:underline">
										X PPLG 2
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								...
								<li>
									<a href="https://www.instagram.com/smkn7.baleendah" class="hover:underline">
										Instagram Sekolah
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X PPLG 2 | Di Kelola Oleh Siswa PPLG 2
						</p>
					</div>
				</div>
			</div>
